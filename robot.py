...
class Robot:
    ...
    def draw(self):
        ...
        arcade.draw_circle_filled(settings.SCREEN_SIZE * self.state[0], settings.SCREEN_SIZE * self.state[1], settings.SCREEN_SIZE * settings.ROBOT_SIZE, settings.ROBOT_COLOUR)
