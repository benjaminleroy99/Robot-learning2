...
class Agent:
    ...
    def train_neural_net(self):
        ...
        for training_iteration in range(300): # avant 750
...
class MainProgram(arcade.Window):
    ...
    def __init__(self):
        ...
        for i in tqdm(range(nb_demonstrations[-1])):
            ...
            if i+1 in nb_demonstrations:
                self.list_network_nb_demo.append(self.agent.train_neural_net())
    ...
    def on_draw(self):
        ...
        arcade.draw_circle_filled(settings.SCREEN_SIZE * 0.3,settings.SCREEN_SIZE * 0.8 , radius=5, color=[121, 28, 248])
        arcade.draw_circle_filled(settings.SCREEN_SIZE * 0.3,settings.SCREEN_SIZE * 0.5 , radius=5, color=[121, 28, 248])
